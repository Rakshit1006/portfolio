...
const contactMethods = [
  ...
  },
  {
    ...
    title: "LinkedIn",
    value: "linkedin.com/in/rakshit-kumar-1b0228222/",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Ready to turn your ideas into reality? I&apos;m available for
            freelance projects, full-time opportunities, and technical
            consultations.
          </p>
        </motion.div>
              ...
              {contactMethods.map((method, index) => (
                ...
                >
                  <Card className="bg-card border-border netflix-card-hover h-full group overflow-hidden relative cursor-pointer">
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${method.color} opacity-0 group-hover:opacity-15 transition-all duration-500`}
                    />
        ...
        >
          <div className="bg-gradient-to-r from-red-500/10 to-purple-500/10 border border-red-500/20 rounded-2xl p-8">
            ...
            <p className="text-gray-400 mb-6 max-w-2xl mx-auto">
              From concept to deployment, I&apos;ll help you build scalable,
